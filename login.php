...
body {
    background-image: url("file:///C:/Users/ellaa/OneDrive/Pictures/Screenshots/Screenshot%202024-03-29%20201228.png");
...
<div class="w3-top">
 <div class="w3-bar w3-white w3-card w3-left-align w3-large">
    ...
    <a href="homepage.php" class="w3-bar-item w3-button w3-padding-large w3-brown">Home</a>
    <a href="#" class="w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover-brown">Resources</a>
    <a href="#" class="w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover-brown">Recipes</a>
 ...
 <div id="navDemo" class="w3-bar-block w3-white w3-hide w3-hide-large w3-hide-medium w3-large">
    ...
    <a href="#" class="w3-bar-item w3-button w3-padding-large">Recipes</a>
